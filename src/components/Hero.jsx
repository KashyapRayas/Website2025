...
const Hero = ({linkHovered}) => {
    ...
    useGSAP(() => {
        ...
        t1.current.to(fishingLineRef.current, { height: '352px', duration: 5.6, ease: "linear" }, '+=0.7');
        t1.current.to(fishingLineRef.current, { height: '127px', duration: 5.6, ease: "linear" }, '+=0.7');
    ...
    return (
        ...
        <div className={styles["fishing-line"]} ref={fishingLineRef}>
            ...
            <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.75418 17.0002L1.62291 1.04113L16 8.91842L8.91806 10.973L4.75418 17.0002Z" fill="var(--off-white)" stroke="var(--off-black)"/>
            </svg>
            </div>
        </div>
