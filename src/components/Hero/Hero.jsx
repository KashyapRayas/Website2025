...
const isScrollingRef = useRef(false);
  ...
  // Parallax group on scroll (use SVG element as trigger)
  useGSAP(() => {
      ...
      <div className={styles["heroWrapper"]}>
        ...
        >
            ...
            <g clipPath="url(#clip0_1470_10701)">
                ...
                <path id="line-top" d="M24 140V32" stroke="var(--off-white)" strokeWidth="1.5"/>
                <g id="Face">
                    <path
                    id="Vector 281"
                    ...
                    <g id="upper lip">
                    <path id="Union" d="M143.5 333.5C145.422 331.963 146.882 332.763 147.437 333.42C146.823 332.648 146.743 332.469 151 337.5C155.4 342.699 160.167 338.333 162 335.5C162.667 334 164.6 331.5 167 333.5C170.001 336 180.5 340.5 184 341C184.284 341.04 184.547 341.096 184.789 341.162C186.518 341.394 191.97 341.029 193 340C194.325 338.675 194.87 343.202 190.496 343.93C190.497 343.954 190.5 343.977 190.5 344L189.815 344.01C189.539 344.028 189.248 344.033 188.94 344.022L154 344.5L139.899 336.721C139.747 336.636 139.77 336.409 139.934 336.35C142.354 335.494 141.131 335.395 143.5 333.5Z" fill="#121312"/>
                    </g>
                    <path
                    id="Vector 290"
                    ...
                    fill="var(--off-black)"
                    />
                    <path id="bottom lip" d="M148.999 352C140.199 350 141.332 343.167 142.999 338.5C147.398 335.3 151.499 338.5 153 340.5C156.201 343.7 162.334 342.5 165 341.5C171.4 338.7 180.667 342 184.5 344C179.3 358.8 169.333 356.5 165 355L148.999 352Z" fill="#FBFFFD"/>
                    <g id="Vector 286">
                    <path
