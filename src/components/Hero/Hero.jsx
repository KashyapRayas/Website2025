...
const Hero = ({isLoaded}) => {
    ...
    return (
        ...
        <div className={styles["font-menu"]} onMouseEnter={()=> setFontMenuHovered(true)} onMouseLeave={()=> setFontMenuHovered(false)}>
        ...
        >
            ...
            <g clipPath="url(#clip0_1470_10701)">
                ...
                <g id="Face">
                    ...
                    <path id="Neck BG" d="M142.502 424.5C144.902 407.3 152.169 393.667 155.502 389V328.5L292.5 292L290 315C283.6 325.4 280.333 362.333 279.5 379.5C280.3 387.9 288.5 402 292.5 408C297.7 438.4 256.667 471 235.5 483.5H148L142.502 467.5C137.702 451.1 140.502 432 142.502 424.5Z" fill="var(--off-white)"/>
