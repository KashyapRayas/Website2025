            ...
            <g id="parallax-group" ref={parallaxGroupRef}>
              ...
              <g id="Fisherman with Boat">
                ...
                <g id="Group 31">
                  <path
                    id="Vector 38"
                    d="M121.505 62.9667C116.843 63.1073 104.024 62.8564 96.7988 62.6805C95.9438 62.6597 95.4214 63.4503 96.0245 64.0567C98.1183 66.1619 102.992 68.3347 105.617 69.3075C114.931 71.8933 132.715 69.2409 140.442 67.5914C143.246 67.2424 145.775 65.3691 147.464 63.6736C148.209 62.9257 147.611 61.7802 146.557 61.8281L121.505 62.9667Z"
                    fill="#121312"
                  />
                  <path
                    id="Vector 39"
                    d="M129.458 65.248C119.127 66.1108 103.713 64.3737 96.1924 63.0281C96.0413 63.0011 96.0644 62.7931 96.2179 62.7934C102.836 62.8061 115.085 63.1182 120.767 63.0786L147.032 61.8708C147.361 61.8557 147.461 62.2243 147.153 62.3419C143.21 63.8483 134.098 64.8973 129.458 65.248Z"
                    fill="#FBFFFD"
                  />
                </g>
                <g id="Group 30">
                  <path
                    id="Vector 40"
                    d="M123.825 49.9188C124.69 48.1883 126.637 48.7651 127.502 49.2698C129.059 50.4812 129.593 52.9471 129.665 54.0287L128.8 54.8939C128.973 58.874 128.007 63.7627 127.502 65.7095H125.123C124.603 65.0173 124.041 60.8064 123.825 58.7875L123.176 59.0038V55.3265L122.311 55.9755L121.445 55.5428L123.825 49.9188Z"
                    fill="#121312"
                  />
                  <path
                    id="Ellipse 14"
                    d="M126.419 47.3228C126.419 48.159 125.741 48.837 124.905 48.837C124.069 48.837 123.391 48.159 123.391 47.3228C123.391 46.4865 124.069 45.8086 124.905 45.8086C125.741 45.8086 126.419 46.4865 126.419 47.3228Z"
                    fill="#121312"
                  />
                </g>
                <path
