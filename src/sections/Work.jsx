...
const Work = forwardRef(({ handleProjectSelect }, ref) => {
  ...
  // ClipPath reveal animation when active project changes
    ...
    // Set new src on top layer, collapsed via clippath
    topImgRef.current.src = newSrc;
    gsap.set(topImgRef.current, {
        ...
        <div className="left">
          <div className="img-superwrapper">
            ...
            <div className="first">
              ...
              xmlns="http://www.w3.org/2000/svg"
              >
              <g clipPath="url(#clip0_2996_15697)">
              <path d="M0 9C0 4.02944 4.02944 0 9 0H220C224.971 0 229 4.02944 229 9V123C229 127.971 224.971 132 220 132H9.00001C4.02944 132 0 127.971 0 123V9Z" fill="#C2E9E7"/>
              <rect width="229" height="132" rx="9" fill="#C2E9E7"/>
              ...
              <mask id="path-48-outside-1_2996_15697" maskUnits="userSpaceOnUse" x="0" y="0" width="138" height="48" fill="black">
              <rect fill="white" width="138" height="48"/>
              <path d="M0 9C0 4.02944 4.02944 0 9 0H128.4C133.371 0 137.4 4.02944 137.4 9V34C137.4 38.9706 133.371 43 128.4 43H9.00001C4.02944 43 0 38.9706 0 34V9Z"/>
              </mask>
              <path d="M0 9C0 4.02944 4.02944 0 9 0H128.4C133.371 0 137.4 4.02944 137.4 9V34C137.4 38.9706 133.371 43 128.4 43H9.00001C4.02944 43 0 38.9706 0 34V9Z" fill="#FBFFFD"/>
              <path d="M0 0H137.4H0M137.4 34C137.4 41.732 131.132 48 123.4 48H14C6.26801 48 0 41.732 0 34C0 36.2091 4.02944 38 9 38H128.4C133.371 38 137.4 36.2091 137.4 34ZM137.4 34M0 43V0V43M0 43M137.4 0V43V0" fill="#559991" mask="url(#path-48-outside-1_2996_15697)"/>
              <mask id="path-50-outside-2_2996_15697" maskUnits="userSpaceOnUse" x="45.8008" y="44" width="46" height="49" fill="black">
              <rect fill="white" x="45.8008" y="44" width="46" height="49"/>
              <path d="M45.8008 53C45.8008 48.0294 49.8302 44 54.8008 44H82.6008C87.5714 44 91.6008 48.0294 91.6008 53V79C91.6008 83.9706 87.5713 88 82.6008 88H54.8008C49.8302 88 45.8008 83.9706 45.8008 79V53Z"/>
              </mask>
              <path d="M45.8008 53C45.8008 48.0294 49.8302 44 54.8008 44H82.6008C87.5714 44 91.6008 48.0294 91.6008 53V79C91.6008 83.9706 87.5713 88 82.6008 88H54.8008C49.8302 88 45.8008 83.9706 45.8008 79V53Z" fill="#ECF8F5"/>
              <path d="M45.8008 44H91.6008H45.8008M91.6008 79C91.6008 86.732 85.3328 93 77.6008 93H59.8008C52.0688 93 45.8008 86.732 45.8008 79C45.8008 81.2091 49.8302 83 54.8008 83H82.6008C87.5713 83 91.6008 81.2091 91.6008 79ZM91.6008 79M45.8008 88V44V88M45.8008 88M91.6008 44V88V44" fill="#559991" mask="url(#path-50-outside-2_2996_15697)"/>
              <mask id="path-52-outside-3_2996_15697" maskUnits="userSpaceOnUse" x="0" y="88" width="46" height="49" fill="black">
              <rect fill="white" y="88" width="46" height="49"/>
              <path d="M0 97C0 92.0294 4.02944 88 9 88H36.8C41.7706 88 45.8 92.0294 45.8 97V123C45.8 127.971 41.7706 132 36.8 132H8.99999C4.02943 132 0 127.971 0 123V97Z"/>
              </mask>
              <path d="M0 97C0 92.0294 4.02944 88 9 88H36.8C41.7706 88 45.8 92.0294 45.8 97V123C45.8 127.971 41.7706 132 36.8 132H8.99999C4.02943 132 0 127.971 0 123V97Z" fill="#FBFFFD"/>
              <path d="M0 88H45.8H0M45.8 123C45.8 130.732 39.532 137 31.8 137H14C6.26801 137 0 130.732 0 123C0 125.209 4.02944 127 9 127H36.8C41.7706 127 45.8 125.209 45.8 123ZM45.8 123M0 132V88V132M0 132M45.8 88V132V88" fill="#559991" mask="url(#path-52-outside-3_2996_15697)"/>
              <mask id="path-54-outside-4_2996_15697" maskUnits="userSpaceOnUse" x="183.199" y="0" width="46" height="48" fill="black">
              <rect fill="white" x="183.199" width="46" height="48"/>
              <path d="M183.199 9C183.199 4.02944 187.229 0 192.199 0H219.999C224.97 0 228.999 4.02944 228.999 9V34C228.999 38.9706 224.97 43 219.999 43H192.199C187.229 43 183.199 38.9706 183.199 34V9Z"/>
              </mask>
              <path d="M183.199 9C183.199 4.02944 187.229 0 192.199 0H219.999C224.97 0 228.999 4.02944 228.999 9V34C228.999 38.9706 224.97 43 219.999 43H192.199C187.229 43 183.199 38.9706 183.199 34V9Z" fill="#FBFFFD"/>
              <path d="M183.199 0H228.999H183.199M228.999 34C228.999 41.732 222.731 48 214.999 48H197.199C189.467 48 183.199 41.732 183.199 34C183.199 36.2091 187.229 38 192.199 38H219.999C224.97 38 228.999 36.2091 228.999 34ZM228.999 34M183.199 43V0V43M183.199 43M228.999 0V43V0" fill="#559991" mask="url(#path-54-outside-4_2996_15697)"/>
              <mask id="path-56-outside-5_2996_15697" maskUnits="userSpaceOnUse" x="137.398" y="44" width="46" height="49" fill="black">
              <rect fill="white" x="137.398" y="44" width="46" height="49"/>
              <path d="M137.398 53C137.398 48.0294 141.428 44 146.398 44H174.198C179.169 44 183.198 48.0294 183.198 53V79C183.198 83.9706 179.169 88 174.198 88H146.398C141.428 88 137.398 83.9706 137.398 79V53Z"/>
              </mask>
              <path d="M137.398 53C137.398 48.0294 141.428 44 146.398 44H174.198C179.169 44 183.198 48.0294 183.198 53V79C183.198 83.9706 179.169 88 174.198 88H146.398C141.428 88 137.398 83.9706 137.398 79V53Z" fill="#ECF8F5"/>
              <path d="M137.398 44H183.198H137.398M183.198 79C183.198 86.732 176.93 93 169.198 93H151.398C143.666 93 137.398 86.732 137.398 79C137.398 81.2091 141.428 83 146.398 83H174.198C179.169 83 183.198 81.2091 183.198 79ZM183.198 79M137.398 88V44V88M137.398 88M183.198 44V88V44" fill="#559991" mask="url(#path-56-outside-5_2996_15697)"/>
              </g>
              <defs>
              <clipPath id="clip0_2996_15697">
              <path d="M0 9C0 4.02944 4.02944 0 9 0H220C224.971 0 229 4.02944 229 9V123C229 127.971 224.971 132 220 132H9.00001C4.02944 132 0 127.971 0 123V9Z" fill="white"/>
              </clipPath>
              </defs>
              </svg>
              ...
              <div className="work-img-wrapper"
                ...
                <div className="canvas-wrapper">
                  ...
                  <img
                    ...
                    draggable={false}
                  />
                  {/* Incoming image — animates in via clippath */}
                  <img
                    ref={topImgRef}
